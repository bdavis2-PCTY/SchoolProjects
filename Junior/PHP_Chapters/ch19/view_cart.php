...
if (!empty($_SESSION['cart'])) {
	...
	$q = "SELECT print_id, CONCAT_WS(' ', first_name, middle_name, last_name) AS artist, print_name FROM CH19_artists AS artists, CH19_prints AS prints WHERE artists.artist_id = prints.artist_id AND prints.print_id IN (";
