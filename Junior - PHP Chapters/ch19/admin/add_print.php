...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { // Handle the form.
	...
	if (empty($errors)) { // If everything's OK.
		...
		$q = 'INSERT INTO CH19_prints (artist_id, print_name, price, size, description, image_name) VALUES (?, ?, ?, ?, ?, ?)';
...
<form enctype="multipart/form-data" action="add_print.php" method="post">
	...
	$q = "SELECT artist_id, CONCAT_WS(' ', first_name, middle_name, last_name) FROM CH19_artists ORDER BY last_name, first_name ASC";
